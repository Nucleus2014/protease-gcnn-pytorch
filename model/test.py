...
def test():
    ...
    pkl.dump(logits_test_fin,open(os.path.join(args.save, 'logits_test_hidden_' + str(args.hidden1) + '_linear_' + str(args.linear) +'_lr_'+str(args.lr)+'_wd_'+str(args.weight_decay)+'_bs_'+str(args.batch_size)+ '_dt_' + str(args.dropout)),'wb'))
